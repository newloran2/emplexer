...
function xmlTableHandler:showTable(t)
    local sep = ''
    local res = ''
...
function xmlTableHandler:printHandler ()
    local obj = {}
...
function xmlTableHandler:simpleTreeHandler()
    local obj = {}
...
--- domHandler
function xmlTableHandler:domHandler()
    local obj = {}
