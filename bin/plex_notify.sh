...
time_to_stop=$4 #em porcentagem
time_to_stop=$((playback_duration/100*time_to_stop)) #em porcentagem
...
echo "tempo total para marcar como visto = $4 calculo = $time_to_stop " > /tmp/teste.txt
...
while [[ 1 ]]; do
	...
	a=$((playback_duration - playback_position))
	echo " position = $a" >> /tmp/teste.txt
