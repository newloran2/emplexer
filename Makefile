...
deploy_303d:
	rsync -ravzup  --rsync-path=/ltu/bin/rsync  --exclude '.git' --exclude '*.swp' --exclude '.sublime-project' --exclude '.sublime-workspace' --exclude 'Makefile' --exclude *.zip /Users/newloran2/Dropbox/Projeto/Dune/emplexer/*  root@192.168.2.44:/D/dune_plugins/emplexer2
...
run_lem:
	~/Dropbox/Projeto/Dune/emplexer/bin/lem-mac ~/Dropbox/Projeto/Dune/emplexer/bin/emplexer.lua
pack: clean
