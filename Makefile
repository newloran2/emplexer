...
local_deploy:
	rsync -ravzup  --exclude '.git'  --exclude '.sublime-project' --exclude '.sublime-workspace' --exclude 'Makefile' --exclude *.zip	 /Users/newloran2/Dropbox/Projeto/Dune/emplexer   /Library/WebServer/Documents/
